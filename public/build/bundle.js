...
var app = (function () {
    ...
    var CustomLogging_1 = { customStyles, customStylesObjects };
    ...
    // (343:4) {#each navCrumbObjects as crumb, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 343, 6, 10280);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(343:4) {#each navCrumbObjects as crumb, i}",
    		ctx
    	});
