...
var app = (function () {
    ...
    // (349:4) {#each navCrumbObjects as crumb, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 349, 6, 9856);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(349:4) {#each navCrumbObjects as crumb, i}",
    		ctx
    	});
