    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*navCrumbObjects*/ 1 && t_value !== (t_value = /*crumb*/ ctx[24].name + "")) set_data_dev(t, t_value);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file_1, 179, 10, 4740);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file_1, 192, 10, 5078);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file_1, 176, 6, 4638);
    			attr_dev(div0, "class", "dirs-listing svelte-1d4rth4");
    			add_location(div0, file_1, 177, 6, 4666);
    			add_location(div1, file_1, 175, 4, 4625);
    			add_location(div2, file_1, 187, 4, 4948);
    			add_location(h21, file_1, 189, 6, 4979);
    			attr_dev(div3, "class", "files-listing svelte-1d4rth4");
    			add_location(div3, file_1, 190, 6, 5001);
    			add_location(div4, file_1, 188, 4, 4966);
    			attr_dev(div5, "class", "file-system svelte-1d4rth4");
    			add_location(div5, file_1, 174, 2, 4594);
    			add_location(main, file_1, 172, 0, 4539);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
